...
const CreateCourse = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(`/creator/courses/${response.data.course._id}/lessons`)
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Build an amazing course and share your knowledge with learners worldwide.</p>
        </div>
